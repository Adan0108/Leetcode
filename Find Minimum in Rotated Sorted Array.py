...
# elements of the array to the beginning.
#
...
class Solution:
    def findMin(self, nums: List[int]) -> int:
        ...
        while l < r:
            ...
            # If middle value is greater than right value,
            # the minimum must be on the right side.
            if nums[m] > nums[r]:
                l = m + 1

            # Otherwise, middle could itself be the minimum,
            # or the minimum is somewhere on the left side.
            else:
                r = m
